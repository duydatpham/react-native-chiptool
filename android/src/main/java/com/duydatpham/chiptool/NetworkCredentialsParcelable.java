...
public class NetworkCredentialsParcelable implements Parcelable {
  ...
  public static final Creator<NetworkCredentialsParcelable> CREATOR =
      new Creator<NetworkCredentialsParcelable>() {
  ...
  public static class WiFiCredentials implements Parcelable {
    ...
    public static final Creator<WiFiCredentials> CREATOR =
        new Creator<WiFiCredentials>() {
  ...
  public static class ThreadCredentials implements Parcelable {
    ...
    public static final Creator<ThreadCredentials> CREATOR =
        new Creator<ThreadCredentials>() {
